...
class MainActivity : FlutterActivity() {
    ...
    companion object {
        ...
        private const val RAW_COOKIE_CHANNEL = "com.akuma.fluxseek/raw_cookie"
        private const val ANDROID_CDP_CHANNEL = "com.akuma.fluxseek/android_cdp"
        private const val WEBAUTHN_CHANNEL = "com.akuma.fluxseek/webauthn"
    }
    ...
    private val CHANNEL = "com.akuma.fluxseek/browser"
    private val CRASHLYTICS_CHANNEL = "com.akuma.fluxseek/crashlytics"
    private val ICON_CHANNEL = "com.akuma.fluxseek/app_icon"
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, CRASHLYTICS_CHANNEL).setMethodCallHandler { call, result ->
            when (call.method) {
                "setCrashlyticsEnabled" -> {
                    ...
                    FluxseekApplication.setCrashlytics(enable)
                    result.success(null)
                }
                else -> result.notImplemented()
            }
