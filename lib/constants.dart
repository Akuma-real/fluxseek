...
import 'config/sites/nodeseek.dart';
import 'services/windows_webview_environment_service.dart';

/// 站点能力开关
class SiteFeatures {
  const SiteFeatures({
    required this.nodeSeekRewards,
    required this.connectStats,
  });

  final bool nodeSeekRewards;
  final bool connectStats;
}

/// 应用常量
class AppConstants {
  /// 当前站点自定义配置
  static final SiteCustomization siteCustomization = nodeseekCustomization;

  /// 当前站点能力
  static const SiteFeatures siteFeatures = SiteFeatures(
    nodeSeekRewards: false,
    connectStats: false,
  );
  ...
  static Future<void> initUserAgent() async {
    ...
    if (Platform.isLinux) {
      ...
      debugPrint('[AppConstants] Linux default UA: $_cachedUserAgent');
  ...
  static String _buildDefaultUserAgent() {
    ...
    return 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/605.1.15 '
        '(KHTML, like Gecko) Version/60.5 Safari/605.1.15';
  }

  /// NodeSeek 域名
  static const String baseUrl = 'https://www.nodeseek.com';
