...
class AppCacheManager extends CacheManager with ImageCacheManager {
  static const String key = 'nodeSeekImageCache';
  ...
  Future<Uint8List?> getImageBytes(String url) async {
    try {
      ...
      debugPrint('[AppCacheManager] Failed to get image bytes: $e');
      return null;
    }
  }
  ...
  Future<File?> getCachedFile(String url) async {
    try {
      ...
      debugPrint('[AppCacheManager] Failed to get cached file: $e');
      return null;
    }
  }
  ...
  Future<void> preloadImage(String url) async {
    ...
    try {
      ...
      debugPrint('[AppCacheManager] Failed to preload image: $e');
    } finally {
