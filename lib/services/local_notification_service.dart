...
class LocalNotificationService {
  ...
  Future<void> initialize() async {
    ...
    const windowsSettings = WindowsInitializationSettings(
      appName: 'FluxSeek',
      appUserModelId: 'Com.FluxSeek.FluxSeek',
  ...
  Future<void> show({
    ...
    final androidDetails = AndroidNotificationDetails(
      'nodeseek_notifications',
      S.current.notification_channelNodeSeek,
      channelDescription: S.current.notification_channelNodeSeekDesc,
