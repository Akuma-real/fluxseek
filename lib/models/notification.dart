...
class NodeSeekNotification {
  ...
  factory NodeSeekNotification.fromJson(Map<String, dynamic> json) {
    return NodeSeekNotification(
      id: json['id'] as int,
...
class NotificationListResponse {
  final List<NodeSeekNotification> notifications;
  ...
  factory NotificationListResponse.fromJson(Map<String, dynamic> json) {
    ...
    return NotificationListResponse(
      notifications: notificationsList
          .map((e) => NodeSeekNotification.fromJson(e as Map<String, dynamic>))
          .toList(),
