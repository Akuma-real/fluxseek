...
class _TagSelectionSheetState extends State<TagSelectionSheet> {
  ...
  Future<void> _searchTags(String query) async {
    ...
    try {
      final result = await NodeSeekClient().searchTags(
        query: query,
