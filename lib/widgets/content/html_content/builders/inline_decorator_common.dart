...
/// 获取内联代码的 CSS 样式
Map<String, String> getInlineCodeStyles(
  bool isDark, {
...
Map<String, String> getSpoilerStyles() {
  return {'font-family': '$spoilerMarkerFont, inherit'};
}

/// 构建 click-count Widget
Widget buildClickCountWidget({required String count, required bool isDark}) {
