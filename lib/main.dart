...
Future<void> main() async {
  ...
  // NodeSeek 官方站点首页 SSR 读取会走 WebView；启动期不做全局预热，
  // 由话题列表首屏请求接管，避免重复初始化 WebView。
  final isOfficialNodeSeekHost =
      Uri.tryParse(AppConstants.baseUrl)?.host == 'www.nodeseek.com';
  if (!isOfficialNodeSeekHost) {
...
class _MainPageState extends ConsumerState<MainPage>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      NodeSeekClient().setNavigatorContext(context);
