...
class _ProfilePageState extends ConsumerState<ProfilePage> {
  ...
  Future<void> _logout() async {
    ...
    if (confirmed == true && mounted) {
      ...
      await ref.read(nodeSeekClientProvider).logout(callApi: true);
      if (mounted) {
  ...
  Widget _buildBalanceCards() {
    if (!AppConstants.siteFeatures.nodeSeekRewards) {
    ...
    if (isLoggedIn) {
      ...
      return Padding(
        ...
        child: FilledButton.icon(
          ...
          label: Text(
            context.l10n.profile_loginNodeSeek,
...
class _ProfileHeader extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final canNavigate =
        username != null && username.isNotEmpty && userId != null && userId > 0;
      ...
      onTap: canNavigate
          ? () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (_) =>
                      UserProfilePage(username: username, uid: userId),
                ),
              );
            }
          : null,
      ...
      children: [
        ...
        if (isLoggedIn) ...[
          ...
          Wrap(
            ...
            children: [if (status != null) _buildStatusChip(status, theme)],
          ),
        ] else ...[
          const SizedBox(height: 4),
          Text(
