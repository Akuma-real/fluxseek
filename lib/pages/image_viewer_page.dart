...
class _ImageViewerPageState extends State<ImageViewerPage>
  ...
  Future<void> _saveCurrentImage() async {
    ...
    try {
      ...
      await Gal.putImageBytes(
        imageBytes,
        name: 'fluxseek_${DateTime.now().millisecondsSinceEpoch}.$ext',
      );
  ...
  Future<void> _saveMemoryImage() async {
    ...
    try {
      ...
      await Gal.putImageBytes(
        widget.imageBytes!,
        name: 'fluxseek_${DateTime.now().millisecondsSinceEpoch}.png',
      );
              ...
              children: [
                if (!isGallery)
                  ...
                  GestureDetector(
                    ...
                    child: ExtendedImage(
                      image: appImageProvider(widget.imageUrl!),
                      width: double.infinity,
                      height: double.infinity,
                      fit: BoxFit.contain,
                      mode: ExtendedImageMode.gesture,
                              ...
                              loadStateChanged: (state) {
                                ...
                                if (state.extendedImageLoadState ==
                                  ...
                                  if (thumbUrl != null && thumbUrl != url) {
                                    return Image(
                                      image: appImageProvider(thumbUrl),
                                      fit: BoxFit.contain,
                                    );
                                  }
