...
String get flutterExecutable =>
    ...
    _resolveFlutterExecutableFromHome(_readNonBlankEnv('FLUXSEEK_FLUTTER_HOME')) ??
...
String get toolingStampPath =>
    '.dart_tool${Platform.pathSeparator}fluxseek_tooling${Platform.pathSeparator}pubspec.stamp';
