...
void main(List<String> args) {
  ...
  out.writeln('final Map<String, IconData> faIconNameMapping = {');

  for (final entry in mapEntries.entries) {
    out.writeln(
      "  '${entry.key}': _faIconData(FontAwesomeIcons.${entry.value}),",
    );
  }

  out.writeln('};');
  out.writeln('');
  out.writeln('IconData _faIconData(Object icon) {');
  out.writeln('  if (icon is FaIconData) {');
  out.writeln('    return icon.data;');
  out.writeln('  }');
  out.writeln('  return icon as IconData;');
  out.writeln('}');
