...
## 0.1.0-beta.6 — 2026-05-09

### 变更
- 收敛网络引擎设置入口，网络链路保留 Native / Network / WebView。

### 修复
- 修复 GitHub Release 为空时，应用内“检查更新”把 `/releases/latest` 的 404 响应显示为错误的问题。
- 更新检查缓存 key 升级到 v2，避免旧发布缓存继续触发更新提示。
